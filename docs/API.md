...
```bash
curl -N "http://localhost:3000/api/scan?range=10.10.1.1-10.10.1.10"
```

CIDR:

```bash
curl -N "http://localhost:3000/api/scan?range=10.10.2.0/24"
```

Mixed expression:

```bash
curl -N "http://localhost:3000/api/scan?range=10.10.1.8,10.10.2.0/30,10.10.3.10-10.10.3.20"
```
